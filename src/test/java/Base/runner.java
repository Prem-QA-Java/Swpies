...
public class runner extends Hooks {
	...
	public void login() throws InterruptedException {
		...
		if (dd.getDay() == 0 || dd.getDay() == 6) {
			...
			d.findElement(By.id("txtDomain")).sendKeys(prop("domin"));
				d.findElement(By.id("txtUserName")).sendKeys(id);
				d.findElement(By.id("txtPassword")).sendKeys(pass);
				d.findElement(By.id("btnLogin")).click();
				//To check the button is swiped in or swiped out if it is already swiped in ten if will execute
				if (d.findElement(By.xpath("//*[@ng-click='applAttendance()'][1]")).getAttribute("class").contains("newpaytimein ng-binding ng-hide")) {
					String lastSwiped = d.findElement(By.xpath("//*[@ng-if='lastSwipedStatus']//p")).getText();
					System.out.println(lastSwiped);
					...
					if(time==presentTime||time<presentTime) {
						...
						System.out.println(pause*36000);
						Thread.sleep((long) (pause*36000));
						d.findElement(By.xpath("//*[@ng-click='applAttendance()'][2]")).click();
